...
/**
 * <p>
 * A customized implementation of <code>java.util.TreeMap</code> designed to
...
public class FastTreeMap extends TreeMap {
  ...
  /**
   * Construct a new map with the same mappings as the specified map, sorted
   * according to the keys's natural order
   *
   ...
   * <code>null</code> if the map contains no mapping for this key, or if there is
   * a mapping with a value of <code>null</code>. Use the
  ...
  /**
   * Return <code>true</code> if this map contains one or more keys mapping to the
   * specified value.
   *
  ...
  /**
   * Return the comparator used to order this map, or <code>null</code> if this
   ...
   * documentation for the <code>Map.equals</code> method.
   *
   ...
   * the <code>Map.hashCode</code> method.
   * 
  ...
  /**
   * Return a shallow copy of this <code>FastTreeMap</code> instance. The keys and
  ...
  /**
   * Return a view of the portion of this map whose keys are in the range fromKey
   ...
   * in the returned collection is a <code>Map.Entry</code>.
   */
  public Set entrySet() {
    return new EntrySet();
  }
