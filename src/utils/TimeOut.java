...
public class TimeOut {
   ...
   * @param timeout   The time in milliseconds before target will be interrupted
   *                  or stopped
   * @param forceStop If true, will Thread.stop() this target instead of just
   *                  interrupt()
   */
  ...
  private class Interrupter implements Runnable {
    ...
    public void run() {
      ...
      try {
        ...
        // If the Child and Interrupter finish at the exact same millisecond we'll get
        // here
